...
def setup_logger_kwargs(exp_name, seed=None, output_dir=None, datestamp=False):
    """
    ...
    data_dir = output_dir or True
    logger_kwargs = dict(output_dir=osp.join(data_dir, relpath),
                         exp_name=exp_name)
    return logger_kwargs


# log_demo = setup_logger_kwargs("demo", seed=1, output_dir="../sp_data_logs")
# print("log_demo:", log_demo)
...
class Logger:
    ...
    def __init__(self, output_dir=None,
                 output_fname='progress.txt', exp_name=None):
        """
        Initialize a Logger.
