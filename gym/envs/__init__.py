...
register(
    id='PusherHER-v1',
    entry_point='gym.envs.mujoco:PusherHEREnv',
    max_episode_steps=100,
    reward_threshold=0.0,
)
...
register(
    id='ReacherHER-v1',
    entry_point='gym.envs.mujoco:ReacherHEREnv',
    max_episode_steps=100,
    reward_threshold=0.0,
)

register(
    id='ReacherHERHarder-v1',
    entry_point='gym.envs.mujoco:ReacherHERHarderEnv',
    max_episode_steps=100,
    reward_threshold=0.0,
)
...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='FetchObsPush{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchObsPushEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='FetchInsert{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchInsertEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='FetchDrawer{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchDrawerEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    # Hand
