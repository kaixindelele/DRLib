...
class FetchEnv(robot_env.RobotEnv):
    ...
    def _reset_sim(self):
        ...
        # rand_x = np.random.random() * 0.3 - 0.15
        # rand_y = np.random.random() * 0.3 - 0.15
        # # print("self.sim.model.body_pos[self.sim.model.body_name2id('drawercase_link')]:",
        # #       self.sim.model.body_pos[self.sim.model.body_name2id('drawercase_link')])
        #
        # self.sim.model.body_pos[self.sim.model.body_name2id('drawercase_link')] = np.array([rand_x, rand_y,
        #     self.sim.model.body_pos[self.sim.model.body_name2id('drawercase_link')][2]])
        # self.sim.data.set_joint_qpos('goal_slidey', 0.02)
    ...
    def _sample_goal(self):
        object_pos = self.sim.data.get_site_xpos('objGeom')
        goal_x = -np.random.random() * 0.16 + object_pos[0] - 0.04
        # goal_y = np.random.random() * 0.24 - 0.12 + object_pos[1]
        goal_y = object_pos[1]
        goal_z = object_pos[2]
