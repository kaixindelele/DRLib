...
from gym.envs.robotics import fetch_drawer_env


# Ensure we get the path separator correct on windows
MODEL_XML_PATH = os.path.join('fetch', 'drawer.xml')


class FetchDrawerEnv(fetch_drawer_env.FetchEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        fetch_drawer_env.FetchEnv.__init__(
