...
from gym.envs.robotics import fetch_drawer_open_env
...
class FetchDrawerOpenEnv(fetch_drawer_open_env.FetchEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        fetch_drawer_open_env.FetchEnv.__init__(
