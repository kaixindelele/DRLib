...
from gym.envs.robotics import rotations, robot_stack_env, utils
...
class FetchEnv(robot_stack_env.RobotEnv):
    ...
    def _get_obs(self):
        ...
        dist_01 = object_pos - object1_pos
        obs = np.concatenate([
    ...
    def _reset_sim(self):
        ...
        if self.has_object:
            obj0_xpos, obj1_xpos = self.sample_all_obj_pos()
            # obj0
