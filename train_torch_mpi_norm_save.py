...
def launch(net, args):
    ...
    # restore_path = 'HER_DRLib_exps/2021-02-22_HER_TD3Torch_FetchPush-v1/2021-02-22_14-46-52-HER_TD3Torch_FetchPush-v1_s123/'
    # net.load_simple_network(restore_path+"actor.pth")
    # net.load_norm(restore_path+"replay.pkl")
